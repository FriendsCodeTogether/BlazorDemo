...
namespace BlazorDemoML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Joren\AppData\Local\Temp\2a202ea1-5b54-4970-8260-07fa1902a96f.tsv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.LoadImages("ImageSource_featurized", null, "ImageSource")
                                      ...
                                      .Append(mlContext.Transforms.ExtractPixels("input1", "ImageSource_featurized"))
